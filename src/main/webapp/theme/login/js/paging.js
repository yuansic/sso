...
(function(root, factory) {
	...
	Paging.prototype = {
		...
		format: function() {
			...
			html += '<li class="js-page-prev js-page-action ui-pager page_fa" style="font-size: 26px;"><i class="fa fa-angle-left page_fa" aria-hidden="true"></i></li>';
			if (this.pagecount > 6) {
				html += '<li data-page="1" class="ui-pager ui-pageNum">1</li>';
				if (this.current <= 2) {
					html += '<li data-page="2" class="ui-pager ui-pageNum">2</li>';
					html += '<li data-page="3" class="ui-pager ui-pageNum">3</li>';
				...
				if (this.current > 2 && this.current <= this.pagecount - 2) {
					...
					html += '<li data-page="' + (this.current - 1) + '" class="ui-pager ui-pageNum">' + (this.current - 1) + '</li>';
					html += '<li data-page="' + this.current + '" class="ui-pager ui-pageNum">' + this.current + '</li>';
					html += '<li data-page="' + (this.current + 1) + '" class="ui-pager ui-pageNum">' + (this.current + 1) + '</li>';
					html += '<li class="ui-paging-ellipse" class="ui-pager ui-pageNum">' + this.settings.ellipseTpl + '</li>';
				} else {
					html += '<li class="ui-paging-ellipse" >' + this.settings.ellipseTpl + '</li>';
					for (var i = this.pagecount - 2; i < this.pagecount; i++) {
						html += '<li data-page="' + i + '" class="ui-pager ui-pageNum">' + i + '</li>'
					}
				}
				html += '<li data-page="' + this.pagecount + '" class="ui-pager ui-pageNum">' + this.pagecount + '</li>';
			} else {
				for (var i = 1; i <= this.pagecount; i++) {
					html += '<li data-page="' + i + '" class="ui-pager ui-pageNum">' + i + '</li>'
				}
			}
			html += '<li class="js-page-next js-page-action ui-pager" style="font-size: 26px;"><i class="fa fa-angle-right" aria-hidden="true"></i></li>';
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class=""><select class="ui-select-pagesize"></select><span class="pageTxt">&nbsp;&nbsp;&nbsp;跳至&nbsp;&nbsp;</span><input type="text" class="ui-paging-count "/><span class="pageTxt">&nbsp;&nbsp;页</span></li>');
