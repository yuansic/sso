var ssoSessions = (function () {
    var urls = {
        destroy: {
            all: _base+'/statistics/ssosessions/destroySsoSessions',
            single: _base+'/statistics/ssosessions/destroySsoSession'
        },
        getSessions:  _base+'/statistics/ssosessions/getSsoSessions'
    };
    ...
    var createDataTable = function() {
        $('#ssoSessions').DataTable( {
            ...
            "processing": true,
            "ajax": {
                "url":  _base+'/statistics/ssosessions/getSsoSessions',
